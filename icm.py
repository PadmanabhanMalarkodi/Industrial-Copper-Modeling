...
if selected == "Selling Price Prediction":
    ...
    with open(r"C:\\Users\\HP\\Desktop\\GUVI Projects\\Industrial Copper Modeling\\model.pkl", 'rb') as file_1:
...
if selected == "Status (Win/Lost)":
    ...
    with open(r"C:\\Users\\HP\\Desktop\\GUVI Projects\\Industrial Copper Modeling\\classfier_model.pkl", 'rb') as file_2:
